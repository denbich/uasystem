...
<script>
    ...
    const data1 = {
      ...
      datasets: [{
        ...
        data: [{{ $stats['rybnik'].", ".$stats['jejkowice'].", ".$stats['szczerbice'].", ".$stats['gaszowice'].", ".$stats['czernica'].", ".$stats['lyski'].", ".$stats['sumina'].", ".$stats['rudy'].", ".$stats['rydultowy'].", ".$stats['radlin'].", ".$stats['pszow'].", ".$stats['jankowice'].", ".$stats['swierklany'].", ".$stats['zory'].", ".$stats['czerleszcz'].", ".$stats['palowice'].", ".$stats['wodzislaw'] }}],
      },
    ]
    };
