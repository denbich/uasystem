    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <h6 class="navbar-heading p-0 text-muted">
          ...
          <ul class="navbar-nav">
            @include('organisation.include.refugees')
          </ul>
          ...
          <ul class="navbar-nav mb-md-3">
            @include('organisation.include.other')
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">{{ __('Panel 28 dzielnicy') }}</h6>
                  ...
                  <div class="card-header">
                    <div class="row align-items-center">
                      ...
                      <div class="col text-right">
                        <a href="{{ route('o.ukrainian.list') }}" class="btn btn-sm btn-primary">{{ __('shop.dashboard.stats.button') }}</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
